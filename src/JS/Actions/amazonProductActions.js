...
export const addproduct = (newProduct) => async (dispatch) => {
  ...
  try {
    const result = await axios.post(
      "https://ecommerceback-nrm6.onrender.com/api/amazonProduct/addproduct",
      newProduct
    );
...
export const getproduct = () => async (dispatch) => {
  ...
  try {
    const result = await axios.get(
      "https://ecommerceback-nrm6.onrender.com/api/amazonProduct/getproduct"
    );
...
export const getproductbyid = (_id) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      `https://ecommerceback-nrm6.onrender.com/api/amazonProduct/getproductbyid/${_id}`
    );
...
export const getproductbyasin = (category_name) => async (dispatch) => {
  try {
    ...
    // Make a GET request to fetch product by ID
    const response = await axios.get(
      `https://ecommerceback-nrm6.onrender.com/api/amazonProduct/getproductbyasin/${category_name}`
    );
...
export const deleteproduct = (_id) => async (dispatch) => {
  ...
  try {
    const result = await axios.delete(
      `https://ecommerceback-nrm6.onrender.com/api/amazonProduct/deleteproduct/${_id}`
    );
...
export const editproduct = (_id, prix) => async (dispatch) => {
  ...
  try {
    const result = await axios.put(
      `https://ecommerceback-nrm6.onrender.com/api/amazonProduct/editproduct/${_id}`,
      prix
    );
